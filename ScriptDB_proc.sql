...
GO
INSERT [dbo].[LOPHOC] ([MALOP], [NGAYBATDAU], [NGAYKETTHUC], [PHONGHOC], [LICH_HOC], [SISO_TOIDA], [SISO], [MAMH]) VALUES (N'LH01', CAST(N'2021-08-20' AS Date), CAST(N'2021-07-12' AS Date), N'C203', N'Thứ 6', 100, 1, N'MH09')
INSERT [dbo].[LOPHOC] ([MALOP], [NGAYBATDAU], [NGAYKETTHUC], [PHONGHOC], [LICH_HOC], [SISO_TOIDA], [SISO], [MAMH]) VALUES (N'LH02', CAST(N'2021-08-28' AS Date), CAST(N'2021-08-13' AS Date), N'C301', N'Thứ 4', 100, 0, N'MH04')
INSERT [dbo].[LOPHOC] ([MALOP], [NGAYBATDAU], [NGAYKETTHUC], [PHONGHOC], [LICH_HOC], [SISO_TOIDA], [SISO], [MAMH]) VALUES (N'LH03', CAST(N'2021-08-12' AS Date), CAST(N'2021-06-22' AS Date), N'E101', N'Thứ 3', 100, 0, N'MH04')
INSERT [dbo].[LOPHOC] ([MALOP], [NGAYBATDAU], [NGAYKETTHUC], [PHONGHOC], [LICH_HOC], [SISO_TOIDA], [SISO], [MAMH]) VALUES (N'LH04', CAST(N'2021-08-12' AS Date), CAST(N'2021-05-14' AS Date), N'F101', N'Thứ 4', 100, 0, N'MH03')
INSERT [dbo].[LOPHOC] ([MALOP], [NGAYBATDAU], [NGAYKETTHUC], [PHONGHOC], [LICH_HOC], [SISO_TOIDA], [SISO], [MAMH]) VALUES (N'LH05', CAST(N'2021-08-07' AS Date), CAST(N'2021-03-24' AS Date), N'F303', N'Thứ 2', 100, 0, N'MH05')
GO
...
AS
	...
	WHERE NGAYBATDAU < GETDATE() AND LOAI_MH LIKE @program AND MH.MAMH IN (
	SELECT MAMH
	FROM dbo.LOPHOC
...
WHERE MALOPHOC = '' AND MAPHIEUDANKY_LOPHOC = ''
